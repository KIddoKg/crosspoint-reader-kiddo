...
class CrossPointSettings {
 ...
 public:
  ...
  // UI Theme
  enum UI_THEME { CLASSIC = 0, LYRA = 1, LYRA_3_COVERS = 2, GRID_HOME = 3 };
  ...
  // Timezone offset in seconds (for WiFi sync persistence)
  // Stored when WiFi syncs time from NTP, restored on boot
