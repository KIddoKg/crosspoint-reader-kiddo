  ...
  return {
      ...
      SettingInfo::Enum(
          ...
          {StrId::STR_NONE_OPT, StrId::STR_NO_PROGRESS, StrId::STR_STATUS_BAR_FULL_PERCENT,
           ...
           StrId::STR_STATUS_BAR_TIME_CHAPTER},
      ...
      SettingInfo::Enum(StrId::STR_UI_THEME, &CrossPointSettings::uiTheme,
                        {StrId::STR_THEME_CLASSIC, StrId::STR_THEME_LYRA, StrId::STR_THEME_LYRA_EXTENDED, StrId::STR_THEME_GRIDHOME}, "uiTheme",
                        StrId::STR_CAT_DISPLAY),
      ...
      SettingInfo::Toggle(StrId::STR_TIME_TRACKING_IN_SLEEP, &CrossPointSettings::timeTrackingInSleep, "timeTrackingInSleep",
